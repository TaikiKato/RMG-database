...
shortDesc = u""
longDesc = u"""
Abraham (s_g, b_g, e_g, l_g, a_g, c_g) and Mintz solvent parameters (s_h, b_h, e_h, l_h, a_h, c_h) are 
fitted by Yunsie Chung and Pierre Walker using experimental solute parameter, solvation free energy, 
and solvation enthalpy data. Abraham solvent parameters are used for solvation free energy (dGsolv) calculations,
and Mintz solvent parameters are used for solvation enthalpy (dHsolv) calculations.
